	...
	if($count != 0) {
		...
		while($comment = mysqli_fetch_array($get_comments)) {
			...
			<div class="comment_section">
				...
				<a href="<?php echo $posted_by?>" target="_parent" style='color: #0645AD;'> <b> <?php echo $user_obj->getFirstAndLastName(); ?> </b></a>
				&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $time_message . "<br>" . $comment_body; ?> 
				<br>
				<hr style='border-top:1px solid white;background:white;border-radius:50%;'>
			</div>
			<?php
