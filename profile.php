...
*/
 ?>
 	...
 	<div class="profile_left">
         <?php 
         if ($user_array['profile_pic']=="")
         {
             $user_array['profile_pic']="images\Userpanelimg.png";
         }
         ?>
...
<p><?php echo "Hobbies: " . $num_hobbies ?></p>
<p>
<?php 
  
    $hobby=explode(",",$user_array['hobbies']);
    foreach($hobby as $out){
      $out=$out."\n";
      echo nl2br($out);
